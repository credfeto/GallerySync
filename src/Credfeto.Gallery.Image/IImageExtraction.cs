...
public interface IImageExtraction
{
    ...
    /// </returns>
    byte[] SaveImageAsJpegBytes(Image<Rgba32> image, long compressionQuality, string url, string shortUrl, IReadOnlyList<PhotoMetadata> metadata, DateTime creationDate, IImageSettings imageSettings);
